...
caption_display_time = 5  # seconds
start_time = 0
...
while True:
    ...
    # Press 'c' to capture the frame and generate a caption
        ...
        start_time = time.time()  # update the start time for displaying the caption

    if time.time() - start_time < caption_display_time:
        cv2.putText(
            frame_with_caption,
            "Caption :"+caption,
            (10, frame_with_caption.shape[0] // 2),
